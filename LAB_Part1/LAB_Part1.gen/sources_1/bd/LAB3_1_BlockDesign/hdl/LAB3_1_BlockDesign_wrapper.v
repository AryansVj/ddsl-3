...
//Command     : generate_target LAB3_1_BlockDesign_wrapper.bd
//Design      : LAB3_1_BlockDesign_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module LAB3_1_BlockDesign_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  LAB3_1_BlockDesign LAB3_1_BlockDesign_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
